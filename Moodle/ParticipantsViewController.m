...
- (void)viewDidLoad
{
    ...
    if (!offlineMode) {
        WSClient *client = [[WSClient alloc] initWithToken: @"http://jerome.moodle.local/~jerome/Moodle_HEAD/webservice/xmlrpc/server.php?wstoken=acabec9d20933913f14309785324f579"];
